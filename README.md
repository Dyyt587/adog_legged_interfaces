...
If you are familiar with ROS 2, here are the quick-and-dirty build instructions.
  ...
  git clone git@github.com:adog/adog_legged_interfaces.git src/adog_legged_interfaces
  vcs import src --input src/adog_legged_interfaces/adog_legged_interfaces.humble.repos
  vcs import src --input src/adog_legged_interfaces/adog_legged_interfaces.humble.upstream.repos
